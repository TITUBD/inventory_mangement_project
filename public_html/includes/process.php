			...
			?>
				<tr>
			        ...
			        <td>
			        	...
			        	<a href="#" eid="<?php echo $row['cid']; ?>" data-toggle="modal" data-target="#form_category" class="btn btn-info btn-sm edit_cat">Update</a>
			        </td>
			      </tr>
			<?php
			$n++;
			...
			?>
				<tr>
			        ...
			        <td>
			        	...
			        	<a href="#" eid="<?php echo $row['bid']; ?>" data-toggle="modal" data-target="#form_brand" class="btn btn-info btn-sm edit_brand">Update</a>
			        </td>
			      </tr>
			<?php
			$n++;
			...
			?>
				<tr>
			        ...
			        <td>
			        	...
			        	<a href="#" eid="<?php echo $row['pid']; ?>" data-toggle="modal" data-target="#form_products" class="btn btn-info btn-sm edit_product">Update</a>
			        </td>
			      </tr>
			<?php
			$n++;
